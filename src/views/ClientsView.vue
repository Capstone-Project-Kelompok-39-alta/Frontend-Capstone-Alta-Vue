        ...
        <div class="row ms-5 mb-5">
          <div class="card-custom d-flex">
            <div class="flex-coloumn">
              <div class="mt-3 ms-3">Category</div>

              <div class="dropdown">
                <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">Pulsa</button>
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                  <li><a class="dropdown-item" href="#">PDAM</a></li>
                  <li><a class="dropdown-item" href="#">Listrik</a></li>
          ...
          <div class="card-custom d-flex">
            <div class="flex-coloumn">
              <div class="mt-3 ms-3">Code</div>
              <div class="mt-2 ms-3" style="font-weight: 700">BD-100-22</div>
            </div>
          </div>
          <div class="card-custom d-flex">
            <div class="flex-coloumn">
              ...
              <div class="dropdown">
                <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">Any</button>
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
